...
# TODO Clark: It seems I cannot register a class without adding
# some slot to it, so that's why there's a dummy slot here.
setClass("fork.ddR", contains = "ddRDriver", slots = c(dummy = "character"))
...
#
#   dots <- c(list(FUN = func, MoreArgs = MoreArgs, SIMPLIFY = FALSE,
#             mc.cores = ddR.env$driver@executors), dots)
